...
describe Video do
  ...
  describe "#search_by_title" do
    ...
    it "returns an empty array if there is no match" do
      Video.create(title: "Monk", description: "A funny man.", category: category)
      search_result = Video.search_by_title("not")

      expect(search_result).to eq([])
    end
    
    it "returns an array of a single matched video" do
      monk = Video.create(title: "Monk", description: "A funny man.", category: category)
    ...
    it "returns an array of a single partially matched video" do
      familyguy = Video.create(title: "Family Guy", description: "A funny family.", category: category)
    ...
    it "returns an array of multiple matached videos ordered by created_at" do
      familymatters = Video.create(title: "Family Matters", description: "A Chicago family.", category: category)
      familyguy = Video.create(title: "Family Guy", description: "A funny family.", created_at: "2013-03-18 04:53:45", category: category)
      search_rslt = Video.search_by_title("Family")
