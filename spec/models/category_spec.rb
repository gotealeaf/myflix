...
describe Category do
  ...
  describe "#recent_videos" do
    it "returns the videos in the reverse chronological order by created_at" do
      ...
      south_park = Video.create(title: "South Park", description: "park", category: comedies)
    ...
    it "returns the most recent 6 videos" do
      ...
      expect(comedies.recent_videos.count).to eq(6)
      tonights_show = Video.create(title: "tonights_show", description: "talk show", category: comedies, created_at: 1.day.ago)
