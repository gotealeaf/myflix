...
describe Category do
  ...
  describe "#display_most_recent_videos" do
    ...
    it 'returns an array of the no more than 6 videos' do
      category = Category.create(title: 'Animation', description: "This is for drawn shows." )
      Video.create(title: 'Vid 1', description: "This is a show about a family.", category: category)
      Video.create(title: 'Vid 2', description: "This is a show about a family.", category: category)
      Video.create(title: 'Vid 3', description: "This is a show about a family.", category: category)
      Video.create(title: 'Vid 3', description: "This is a show about a family.", category: category)
      Video.create(title: 'Vid 4', description: "This is a show about a family.", category: category)
      Video.create(title: 'Vid 41', description: "This is a show about a family.", category: category)
      Video.create(title: 'Vid 412', description: "This is a show about a family.", category: category)
      Video.create(title: 'Vid 4122', description: "This is a show about a family.", category: category)
      Video.create(title: 'Vid 41223', description: "This is a show about a family.", category: category)
      expect(category.display_most_recent_videos.count).to eq(6)
    end
    it 'returns an array ordered by created_at' do
      category = Category.create(title: 'Animation', description: "This is for drawn shows." )
      Video.create(title: 'Vid 1', description: "This is a show about a family.", category: category, created_at: 9.minutes.ago)
      Video.create(title: 'Vid 2', description: "This is a show about a family.", category: category, created_at: 8.minutes.ago)
      Video.create(title: 'Vid 3', description: "This is a show about a family.", category: category, created_at: 7.minutes.ago)
