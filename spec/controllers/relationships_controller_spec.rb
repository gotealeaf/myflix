...
describe RelationshipsController do
  ...
  describe "DELETE destroy" do
    ...
    it "doesnt delete the relationship if the current user is not the follower" do
      alice = Fabricate(:user)
      bob = Fabricate(:user)
  ...
  describe "POST create" do
    ...
    it "doesnt create a relationship if the current user already follow the leader" do
      alice = Fabricate(:user)
      bob = Fabricate(:user)
      set_current_user(alice)
    ...
    it "doesnt allow one to follow themselves" do
      alice = Fabricate(:user)
      bob = Fabricate(:user)
      set_current_user(alice)
