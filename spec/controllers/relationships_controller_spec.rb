...
describe RelationshipsController do
  ...
  describe "POST create" do
    ...
    it "creates a relationship if the current user follows the leader" do
      alice = Fabricate(:user)
      bob = Fabricate(:user)
      set_current_user(alice)
    ...
    it "it does not create a relationship if the current user is already following the leader" do
      alice = Fabricate(:user)
      bob = Fabricate(:user)
      set_current_user(alice)
