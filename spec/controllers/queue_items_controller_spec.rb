...
describe QueueItemsController do
  describe "GET index" do
    it "sets @queue_items to the queue items of the logged in user" do
      ...
      queue_item1 = Fabricate(:queue_item, user_id: alice.id)
      queue_item2 = Fabricate(:queue_item, user_id: alice.id)
      get :index
  ...
  describe "POST create" do
    ...
    it "puts the video as the last one in the queue" do
      ...
      post :create, video_id: video.id
      video_queue_item = QueueItem.where(video_id: video.id, user_id: alice.id).first
  ...
  describe "POST update_queue" do
    ...
    it_behaves_like "require sign in" do
      let(:action) { post :update_queue, queue_items: [{id: 2, position: 2}, {id: 6, position: 1}] }
    end
