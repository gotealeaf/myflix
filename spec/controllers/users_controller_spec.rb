...
describe UsersController do
  ...
  describe "POST create" do
    ...
    context "with invalid input" do
      before { post :create, user: { email: "dennysantoso@example.com", password: "admin", password_confirmation: "admin"} }
    ...
    context "sending emails" do
      ...
      it "sends out email to the user with valid inputs" do
        post :create, user: {email: "joe@example.com", password: "password", password_confirmation: "password", full_name: "Joe Smith"}
  ...
  describe "GET new_with_invitation_token" do
    ...
    it "redirects to expired token page for invalid tokens" do
      get :new_with_invitation_token, token: 'adfsdfs'
