  ...
  describe 'POST create' do
    context 'if validation passes' do
      it 'creates a new user' do
        post :create, user: Fabricate.attributes_for(:user), stripeToken: stripe_valid_token.id
      ...
      it 'delivers to the correct recipient' do
        post :create, user: { username:'test_user', full_name: 'test_user',
                              ...
                              password_confirmation: 'password' }, stripeToken: stripe_valid_token.id
      ...
      context 'if user was invited to register' do
        it 'should delete the token after registration' do
          ...
          post :create, user: Fabricate.attributes_for(:user), token: user_token.token, stripeToken: stripe_valid_token.id
