...
feature "User interacts with the queue" do
  scenario "user adds and reorders videos in the queue" do
    ...
    find_and_set_video_position(monk, 3)
    find_and_set_video_position(south_park, 1)
    find_and_set_video_position(futurama, 2)
  ...
  def find_and_set_video_position(video, position)
