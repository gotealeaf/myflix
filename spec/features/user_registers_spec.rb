...
feature 'User registers', js: true, driver: :selenium do
  ...
  scenario 'with valid personal info and valid card' do
    ...
    register_with_valid_info_and_valid_card
  ...
  scenario 'with valid personal info and invalid card' do
    ...
    register_with_valid_info_and_invalid_card
  ...
  scenario 'with valid personal info and card declined' do
    ...
    register_with_valid_info_and_declined_card
  ...
  scenario 'with invalid personal info and valid card' do
    ...
    fill_in_user_info(alice)
    fill_in_valid_credit_card_info
    register_with_invalid_info_and_valid_card
  ...
  scenario 'with invalid personal info and invalid card' do
    ...
    fill_in_user_info(alice)
    fill_in_invalid_credit_card_info
    register_with_invalid_info_and_invalid_card
    confirm_rejection_for_invalid_card
    sign_in_user(alice)
    confirm_user_not_registered
  end
  ...
  scenario 'with invalid personal info and card declined' do
    ...
    fill_in_user_info(alice)
    fill_in_declined_credit_card_info
    register_with_invalid_info_and_declined_card
    confirm_rejection_for_invalid_info
    sign_in_user(alice)
    confirm_user_not_registered
  end
...
def register_with_valid_info_and_valid_card
  VCR.use_cassette("valid_info_and_valid_card_feature_spec") do
...
def register_with_valid_info_and_invalid_card
  VCR.use_cassette("valid_info_and_invalid_card_feature_spec") do
    click_button "Register"
  end
end
...
def register_with_valid_info_and_declined_card
  VCR.use_cassette("valid_info_and_declined_card_feature_spec") do
    click_button "Register"
  end
end
...
def register_with_invalid_info_and_valid_card
  VCR.use_cassette("invalid_info_and_valid_card_feature_spec") do
    click_button "Register"
  end
end
...
def register_with_invalid_info_and_invalid_card
  VCR.use_cassette("invalid_info_and_invalid_card_feature_spec") do
    click_button "Register"
  end
end

def register_with_invalid_info_and_declined_card
  VCR.use_cassette("invalid_info_and_declined_card_feature_spec") do
    click_button "Register"
  end
end