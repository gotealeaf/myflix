...
This is a proof-of-concept app based on the Netflix site, built using TDD and BDD, and featuring full payment processing, account management, and administration capabilities. Some of my learnings include:
