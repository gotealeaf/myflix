...
Video.create(title: 'South Park', description: 'Short Description. ', small_cover_url: 'futurama')
Video.create(title: 'South Park', description: 'Another short description', small_cover_url: 'south_park')
