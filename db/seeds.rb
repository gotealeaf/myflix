...
Relationship.create(follower_id: 1, user_id: 2)
Relationship.create(follower_id: 1, user_id: 3)
Relationship.create(follower_id: 1, user_id: 4)
Relationship.create(follower_id: 1, user_id: 5)
Relationship.create(follower_id: 1, user_id: 6)
