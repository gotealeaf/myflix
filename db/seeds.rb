...
Video.create(name: 'El dia de la bestia', description: lore_ipsum_description, short_image_url: '/tmp/the_day_of_the_beast.jpg', large_image_url: '/tmp/monk_large.jpg')
Video.create(name: 'El dia de la bestia', description: lore_ipsum_description, short_image_url: '/tmp/family_guy.jpg', large_image_url: '/tmp/monk_large.jpg')
...
Video.create(name: 'El dia de la bestia', description: lore_ipsum_description, short_image_url: '/tmp/south_park.jpg', large_image_url: '/tmp/monk_large.jpg')
