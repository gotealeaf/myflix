...
Review.create(video: futurama1, user: user1, rating: 2, review: "This is the text of the first review. Critics panned this episode.")
Review.create(video: futurama1, user: user2, rating: 5, review: "This is the text of the second review.  William Shatner loves Futurama")
Review.create(video: futurama1, user: user3, rating: 4, review: "This is the text of the last review. The general public enjoyed it.")
