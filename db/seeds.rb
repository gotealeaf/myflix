...
south_park = Video.create(title: "South Park", description: "A show with crude language and dark surreal humor...", category_id: 2, small_cover: "/tmp/south_park.jpg", large_cover: "/tmp/monk_large.jpg", created_at: 2.day.ago)
...
User.destroy_all
bob = User.create(full_name: "bob", password: "passoword", email: "bob@example.com")
suzie = User.create(full_name: "suzie", password: "passoword", email: "suzie@example.com")
