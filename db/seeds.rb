...
Video.create(title: "Futurama", description: "Show about future characters", small_cover_url: "/tmp/futurama.jpg", large_cover_url: "/tmp/futurama.jpg", category_id: 1)
Video.create(title: "South Park", description: "Show about town in Colorado", small_cover_url: "/tmp/south_park.jpg", large_cover_url: "/tmp/south_park.jpg", category_id: 2)
monk = Video.create(title: "Monk", description: "Show about a monk", small_cover_url: "/tmp/monk.jpg", large_cover_url: "/tmp/monk.jpg", category_id: 2)

Category.create(name: "Comedies")
Category.create(name: "Dramas")

bob = User.create(full_name: "Bob Bobson", password: "password", password_confirmation: "password", email: "bob@example.com")

Review.create(user: bob, video: monk, rating: 5, content: "This is the best show")
Review.create(user: bob, video: monk, rating: 2, content: "This is the worst show")