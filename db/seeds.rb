...
(1..4).each do |i|
  Video.create!(
    ...
    small_cover_url: path_to_url("/tmp/monk.jpg"),
    large_cover_url: path_to_url("/tmp/monk_large.jpg")
  )
  ...
  Video.create!(
    ...
    small_cover_url: path_to_url("/tmp/family_guy.jpg"),
    large_cover_url: path_to_url("/tmp/family_guy_large.jpg")
  )
  ...
  Video.create!(
    ...
    small_cover_url: path_to_url("/tmp/futurama.jpg"),
    large_cover_url: path_to_url("/tmp/futurama_large.jpg")
  )
  ...
  Video.create!(
    ...
    small_cover_url: path_to_url("/tmp/south_park.jpg"),
    large_cover_url: path_to_url("/tmp/south_park_large.jpg")
  )
end
