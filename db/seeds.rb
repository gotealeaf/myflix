...
QueueItem.create(user: gandalf, video: south_park, position: 1)
QueueItem.create(user: gandalf, video: family_guy, position: 2)
QueueItem.create(user: gandalf, video: monk, position: 3)
QueueItem.create(user: gandalf, video: futurama, position: 4)
